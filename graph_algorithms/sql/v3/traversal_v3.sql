...
BEGIN
    ...
    CREATE TEMPORARY TABLE bfs_edges(src_id VARCHAR(64), dst_id VARCHAR(64), level INTEGER, flag INTEGER)
    ...
    EXECUTE
    'CREATE TABLE ' || result_table_name || '(src_id VARCHAR(64), dst_id VARCHAR(64), attr INTEGER) DISTRIBUTED BY (src_id)';
